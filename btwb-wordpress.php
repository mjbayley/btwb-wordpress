...
if(!defined('BTWB_CDN_WIDGETS_JS_URL')){
    define('BTWB_CDN_WIDGETS_JS_URL', 'https://static.btwb.com/libs/webwidgets/2.0/webwidgets.js');
}

/* CSS - from BTWB CDN to contruct widgets  */
if(!defined('BTWB_CDN_WIDGETS_CSS_URL')){
    define('BTWB_CDN_WIDGETS_CSS_URL', 'https://static.btwb.com/libs/webwidgets/2.0/webwidgets.css');
}
